...
import { ValidationPasswordOptions } from 'src/@shared/Default-Values/Validation-Password-Options';

@Component({
  selector: 'app-validation-password-options',
  templateUrl: './validation-password-options.component.html',
  styleUrls: ['./validation-password-options.component.css']
})
